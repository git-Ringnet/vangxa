...
return [
    ...
    'different_if' => 'Trường :attribute và :other phải khác nhau khi :other là :value.',
    'digits' => 'Độ dài của trường :attribute phải là :digits chữ số.',
    'digits_between' => 'Độ dài của trường :attribute nằm trong khoảng :min và :max chữ số.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Trường :attribute xuất hiện trong một vụ rò rỉ dữ liệu. Vui lòng chọn một :attribute khác.',
    ],
    ...
    'prohibits' => 'Trường :attribute cấm :other từ việc được cung cấp.',
