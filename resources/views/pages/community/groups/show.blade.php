                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-outline-primary dropdown-toggle" type="button"
                                        id="shareGroupButton" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="col-lg-8">
                ...
                <div class="posts-container">
                    @forelse($group->posts as $post)
                        <div class="border p-4 rounded-3 shadow-sm mb-4" data-post-id="{{ $post->id }}">
                            <div class="card-body">
                                ...
                                <div class="post-content mb-3 description-post cursor-pointer"
                                        ...
                                        <div class="d-flex gap-3">
                                            <button class="btn btn-link text-decoration-none p-0 like-btn"
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    <span class="like-count text-post">{{ $post->likes->count() }}</span>
                                                </div>
                                            </button>
                                            @if (!$post->group || ($post->group && $post->group->members->contains(auth()->id())))
                                                <button class="btn btn-link text-decoration-none p-0 comment-toggle"
                                                    ...
                                                    <div class="d-flex gap-2 align-items-center">
                                                        ...
                                                        <span class="text-post">{{ count($post->comments) }}</span>
                                                    </div>
                                                </button>
                                            @endif
                                        </div>
                                            ...
                                            <div class="d-flex gap-2 align-items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="#7c4d28" stroke-width="1.51095" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M11.8901 5.38889L8.00119 1.5L4.1123 5.38889" stroke="#7c4d28"
