    ...
    <div class="nav-container">
        ...
        @if (Auth::check())
            ...
            <form method="POST" action="{{ route('logout') }}">
                <a href="#" class="nav-item">
                    @csrf
                    <button type="submit" class="bg-transparent border-0 p-0 m-0 d-flex align-items-center">
                        <svg class="me-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none">
                            <mask id="mask0_2554_1266" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
